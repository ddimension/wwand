...
scenario('e1820', {
	...
	(modem, mock, events) => {
		...
		ok(e1820_dpfx.action_index('link_set wwan0 noarp') > 0, 'e1820: NOARP on the 802.3 parent');
...
scenario('ladder', {
	...
	(modem, mock, events) => {
		...
		eq(ladder_fx.files['/state/ladder.json'], '{ "attempts": 8, "proto_errors": 0, "rung": 1, "proto_hw": 0, "proven": true, "protocol": null }',
