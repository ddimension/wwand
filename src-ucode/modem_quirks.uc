...
const QUIRKS = [
	...
	//
	// The model is E182E, not E1820, which cannot match: the stick calls itself
	// E182E (`AT+CGMM` on the sponsor's box, revision 11.825.03.00.00 — lsusb's
	// id table says "E815" for 12d1:14ac, and neither is E1820). The `^8$` arm
	// stays because QMI reads the model from DMS, and this modem answers "8"
	// there — it is the arm that matches on the QMI path.
	{
		match: /^E182E|^8$/,
		warn: [
